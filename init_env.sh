...
if [ ! -d "/home/ma-user/work/Ascend/ascend-toolkit/8.0.RC3.alpha003" ]; then
    ./Ascend-cann-toolkit_8.0.RC3.alpha003_linux-aarch64.run --install   --install-path=/home/ma-user/work/Ascend --force --quiet >install.log 2>&1 &
...
echo "source /home/ma-user/work/Ascend/ascend-toolkit/set_env.sh" >> ~/.bashrc
